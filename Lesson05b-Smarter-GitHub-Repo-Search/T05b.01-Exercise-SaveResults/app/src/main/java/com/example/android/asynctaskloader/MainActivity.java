...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String urlTextViewContent = mUrlDisplayTextView.getText().toString();
        // DONE (6) Using the key for the query URL, put the string in the outState Bundle
        outState.putString(SEARCH_QUERY_URL_EXTRA, urlTextViewContent);
        ...
        outState.putString(SEARCH_RESULTS_RAW_JSON, resultRawJson);
    }
